...
[![License](https://img.shields.io/github/license/yabi-zzh/simple-live-ohos)](LICENSE)

基于 [simple-live](https://github.com/xiaoyaocz/simple-live) 的 HarmonyOS NEXT 移植版本。

> **免责声明**：本项目为个人学习移植项目，与原作者无关。所有功能和代码基于原项目进行适配，版权归原作者所有。本项目仅供学习交流使用，不得用于商业用途。使用本项目产生的任何问题由使用者自行承担，与原作者和移植者无关。

## 项目说明

本项目是 simple-live 的 HarmonyOS NEXT 适配版本，使用 flutter_ohos 3.27.4 框架开发。simple-live 是一个简洁的多平台直播聚合应用，支持以下直播平台：
...
**原项目地址**：
- Flutter 版本：[xiaoyaocz/simple-live](https://github.com/xiaoyaocz/simple-live)
- Dart 核心库：[xiaoyaocz/dart_simple_live](https://github.com/xiaoyaocz/dart_simple_live)
...
```bash
# 克隆 flutter_ohos
git clone https://gitcode.com/nicklaus_zheng/flutter_ohos.git -b 3.27.4
...
- 原项目作者：[xiaoyaocz](https://github.com/xiaoyaocz)
  - [simple-live](https://github.com/xiaoyaocz/simple-live) - Flutter 多平台直播应用
  - [dart_simple_live](https://github.com/xiaoyaocz/dart_simple_live) - Dart 核心库
...
本项目采用 [GPL-3.0](LICENSE) 协议开源，继承自原项目 [xiaoyaocz/simple-live](https://github.com/xiaoyaocz/simple-live)。
